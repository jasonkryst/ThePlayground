...
// wrapper's render (parent-before-child) so useMemorySession() sees the intro
  ...
  function SeededIntroDismissed() {
    ...
    if (!seeded.current) {
      ...
      localStorage.setItem('playground_settings', JSON.stringify({
        ...existing,
        introDismissed: { ...existing.introDismissed, 'sound-memory-match': true },
      }))
    }
    return Story()
  }
...
export default {
  title: 'Games/SoundMemoryMatchGame',
  component: SoundMemoryMatchGame,

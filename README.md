...
- **Docker:** a two-stage build (Node compiles, `nginxinc/nginx-unprivileged:1.31-alpine` serves as a non-root user, ~25 MB image). `docker compose up --build`, then open [http://localhost:32800](http://localhost:32800).

...
| `session-resume.spec.js` | Session-resume flow (issue #128): a mid-session exit/reload leaves a resumable snapshot, the resume prompt offers to continue or start fresh within the 4-hour window, and the snapshot expires/clears correctly |
